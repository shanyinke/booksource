...
public class PathUtils {
	...
	public static String search_0="http://mw.vmall.com/search.json?mPage=";
	public static int search_page=1;
	public static String search_1="&sortType=desc&mSortItem=";
	public static int search_item=1;
	public static String search_2="1&mPageSize=12&keyword=";
